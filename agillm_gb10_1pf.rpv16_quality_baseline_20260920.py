...
def train(args):
    ...
    if getattr(args, "quality_probe_ids", None):
        import importlib.util as _ilu
        _spec=_ilu.spec_from_file_location("rpv16_quality_probe", "/workspace/gb10_continue_20260919/heldout_probe.py")
        _mod=_ilu.module_from_spec(_spec); _spec.loader.exec_module(_mod)
        result["fixed_text_validation"]=_mod.run_probe(model, args.quality_probe_ids)
...
def main():
    ...
    t.add_argument("--quality-probe-ids",default=None,help="fixed-text quality probe token IDs; canary only")
